 ...
 */
public class MyConversationClickListener implements RongIM.ConversationBehaviorListener{
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (messageContent instanceof RichContentMessage) {//图文消息
                    ...
                    if("*  添加好友 *".equals(richContentMessage.getTitle())){
                        int[] msg = {message.getMessageId()};
                        RongIM.getInstance().deleteMessages(msg, new RongIMClient.ResultCallback<Boolean>() {
                            @Override
